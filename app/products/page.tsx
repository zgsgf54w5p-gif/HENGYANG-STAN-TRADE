...
import { ArrowRight, ChevronDown, ChevronUp, MessageCircle, Package, Search, ShieldCheck, Sparkles, Zap } from "lucide-react";
                      ...
                      >
                        <div className="space-y-4 p-5">
                          ...
                          <div className="flex flex-wrap gap-2">
                            ...
                            <Link
                              href="/quote"
                              className="inline-flex items-center gap-2 rounded-xl bg-[#FFD700] px-7 py-4 text-base font-semibold text-[#0F172A] transition hover:bg-[#F59E0B] shadow-[0_4px_15px_rgba(255,215,0,0.35)]"
                              onClick={(event) => event.stopPropagation()}
                            >
                              Request Quote
                              <ArrowRight size={15} />
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="inline-flex items-center gap-2 rounded-xl bg-[#25D366] px-7 py-4 text-base font-semibold text-white transition hover:bg-[#1ebe5f] shadow-[0_4px_15px_rgba(37,211,102,0.35)]"
                              onClick={(event) => event.stopPropagation()}
                            >
