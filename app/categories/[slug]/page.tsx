    ...
    <main className="bg-[#F5F8FC] text-slate-800">
      <section className="bg-[#0F172A] text-white">
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 sm:px-8 lg:grid-cols-[1fr_0.8fr] lg:items-center lg:gap-20 lg:px-12 lg:py-24">
          <div>
            <Link href="/products" className="text-sm font-bold uppercase tracking-[0.25em] text-orange-400 transition hover:text-orange-300">
              All products
            </Link>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 sm:px-8 lg:px-12 lg:py-24">
        <div className="mb-10 flex flex-col gap-3 sm:mb-12 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-sm font-bold uppercase tracking-[0.25em] text-[#2563EB]">Available in this category</p>
            <h2 className="mt-3 text-3xl font-extrabold text-[#0F172A] sm:text-4xl">Related products</h2>
          </div>
